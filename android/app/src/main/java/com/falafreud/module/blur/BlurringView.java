package com.falafreud.module.blur;
...
import com.falafreud.R;
import com.falafreud.module.Util;

/**
 * Created by Teruya on 16/02/2018.
 */
...
//            mBlurOutput = Util.fastblur(mBitmapToBlur, 15);
...
//        mBlurOutput.copyTo(mBlurredBitmap);
        ...
        // new
        mBlurOutput.copyTo(Util.fastblur(mBitmapToBlur, 15));
    }
...
//        }
    ...
    private void checkForCircularReference() {
        ...
        if (circularReference) {
            ...
            reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class).emit("ReactNativeBlurError", "BlurView must not be a child of the view that is being blurred.");
